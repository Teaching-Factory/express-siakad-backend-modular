...
const GetKRSMahasiswa = async (req, res, next) => {
  try {
    ...
    const response_kelas_kuliah = await axios.post("http://feeder.ubibanyuwangi.ac.id:3003/ws/live2.php", requestBodyKelasKuliah);
    const response_krs_mahasiswa = await axios.post("http://feeder.ubibanyuwangi.ac.id:3003/ws/live2.php", requestBodyKrsMahasiswa);
