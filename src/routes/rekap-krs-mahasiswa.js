...
router.get("/get-rekap-krs-mahasiswa", checkRole(["admin", "admin-prodi", "mahasiswa"]), checkRole(["admin", "admin-prodi", "mahasiswa"]), RekapKRSMahasiswaController.getRekapKRSMahasiswaByFilterReqBody);
